...
The installation can ask for:

- a bundle archive with local settings and files
- a DB migration

The migration script creates the configured database when needed and then builds the schema.
