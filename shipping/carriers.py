...
class ShippingCarrierDefinition:
    ...
    scale_field_label_key: str | None = None
...
SHIPPING_CARRIER_DEFINITIONS = {
    "gls": ShippingCarrierDefinition(
        ...
        scale_field="shipping_label_scale_mode_gls",
    ...
    "post": ShippingCarrierDefinition(
        ...
        scale_field="shipping_label_scale_mode_post",
    ...
    "free": ShippingCarrierDefinition(
        ...
        scale_field="shipping_label_scale_mode_free",
        scale_field_label_key="field_shipping_scale_mode_free",
